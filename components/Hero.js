    ...
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-start justify-center gap-16">
      <div className="hidden lg:block sm:w-full sm:max-h-screen">
        <Image
          src={fotoHero}
          alt="Product Demo"
          className="bg-contain w-full h-full md::h-screen norepeat"
          priority={true}
          width={500}
          height={500}
        />
      </div>
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start px-8 py-16">
