  ...
  return (
    <>
      <ul role="list" className="divide-y divide-gray-200">
        ...
        <li className="px-2 py-3 sm:px-0">
          <div className="grid grid-cols-7 gap-x-6 items-center mt-1 mb-2">
            <p className="text-sm font-medium text-gray-900">Carlos</p>
            <p className="text-sm font-medium text-gray-900">Hernandez</p>
            <p className="text-sm font-medium text-gray-900">Mon - 1 July</p>
            <p className="text-sm font-medium text-gray-900">9:00</p>
            <p className="text-sm font-medium text-gray-900">6144323432</p>
