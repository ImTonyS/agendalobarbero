...
// Si el day.date === isSelected
//* Necesito que el boton que cambie de mes
//TODO: Necesito hacer el useState para eso
const days = [
  { date: '2021-12-27' },
  { date: '2021-12-28' },
  { date: '2021-12-29' },
...
export default function Date() {
  const primero = 0;
  const [month, setMonth] = useState(months[primero].name)
  console.log(month)
    ...
    <div className="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
      <div className="md:pr-14">
        <div className="flex items-center">
          <h2 className="flex-auto text-sm font-semibold text-gray-900">{month}</h2>
          <button
            type="button"
